...
class SlimeVolleyEnv(gym.Env):
  ...
  def __init__(self):
    ...
    """
    self._survival_bonus = 0 # Depreciated: augment reward, easier to train
    self._distance_bonus = 0 # Augment reward, encourage agent to hit ball away from opponent
...
def multiagent_rollout(env, policy_right, policy_left, render_mode=False):
  ...
  return total_reward, t, distance_traveled, jumping_traveled
